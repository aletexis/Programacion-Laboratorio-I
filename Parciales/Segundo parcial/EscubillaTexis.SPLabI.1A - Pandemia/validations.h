...
/** \brief Obtiene un genero
 *
 * \param result char* Donde se guardara el genero obtenido
 * \param message char* El mensaje a mostrar
 * \param messageError char* El mensaje de error
 * \param tries int La cantidad de intentos
 * \return int (0) si pudo obtenerlo (-1) si no pudo
...
/** \brief Obtiene una respuesta de confirmacion del usuario
 *
 * \param result char* Donde se guardara la respuesta obtenida
 * \param message char* El mensaje a mostrar
 * \param messageError char* El mensaje de error
 * \param tries int La cantidad de intentos
 * \return int (0) si pudo obtenerlo (-1) si no pudo
 *
 */
int validations_getConfirmChar(char* result, char* message, char* messageError, int tries);
/** \brief Valida la respuesta de confirmacion de una cadena
 *
 * \param char El caracter a validar
 * \return int (1) si es valida (0) si no lo es
 *
 */
int isValidConfirmChar(char character);


/** \brief Obtiene un nombre de archivo
 *
 * \param input char* Donde se guardara el nombre de archivo obtenido
 * \param message char* El mensaje a mostrar
 * \param messageError char* El mensaje de error
 * \param minSize int La cantidad minima de digitos a ingresar
 * \param maxSize int La cantidad maxima de digitos a ingresar
 ...
 *
 */
int validations_getPath(char* input, char* message, char* messageError, int minSize, int maxSize, int tries);
/** \brief Valida nombres de archivos de una cadena
 *
 * \param string char* La cadena a validar
 * \param int lenght El largo de la cadena
 * \return int (1) si es valida (0) si no lo es
 *
 */
int isValidPath(char* string, int lenght);
///
