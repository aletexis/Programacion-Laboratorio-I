 ...
 */
int confirm(int menuOption)//le paso el numero de la opcion del menu principal y muestra el mensaje de confirmacion adecuado para la accion que vaya a realizar
{
    char option;
    int confirmed = 0;
